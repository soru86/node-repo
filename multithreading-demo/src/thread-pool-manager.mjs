...
// ThreadPoolManager-wt Worker Thread Code
...
class ThreadPoolManager {
  constructor(obj) {
    ...
    this.name = 'ThreadPoolManager-wt';
    this.build = '6.0';
    ...
    if (this.logging) {
      console.log('========================================================');
      console.log('ThreadPoolManager-wt Build ' + this.build + '; ' + this.buildDate + ' running in process ' + process.pid);
